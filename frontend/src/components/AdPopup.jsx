      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        <div className="relative animate-scale-in">
          ...
          <div className="relative">
            <img
              src="/images/default_offer_poster.png" // Use your ad poster image
              alt="Special Advertisement"
              className="w-full max-w-lg md:max-w-xl lg:max-w-2xl rounded-2xl shadow-2xl animate-slide-in-up"
            />
            
            {/* Close Button - Now inside the poster */}
            <button
              onClick={handleClose}
              className="absolute top-4 right-4 w-8 h-8 bg-white/90 backdrop-blur-sm rounded-full shadow-lg flex items-center justify-center hover:bg-white transition-colors duration-200 z-10"
