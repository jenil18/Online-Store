...
export default function GenNavbar() {
  return (
    <nav
      className={`fixed top-0 left-0 w-full z-20 px-6 py-1 bg-white flex justify-between items-center transition duration-300`}
    >
      <div className="flex items-center space-x-2 ml-[30px]">
        <img
          src="/images/logo2c65.svg"
          alt="Shree Krishna Beauty Products Logo"
          className={`h-[65px] w-auto transition duration-300`}
        />
      </div>
